...
Given the internal properties of a planet (namely radius, material, and density) Blender-Magrathea will automatically create a cross-sectional 3D model of the planet. The planet can also be modeled by [density](https://github.com/Sridotcom/Blender-Magrathea/blob/bfc01bba2d67828b14456e416e70073423a341d3/Density.py) to determine how various. This is extremely useful in visualizing planets to determine changes in density and phases. Additionally, Blender-Magrathea is a useful resource for researchers to publically show their results. Blender-Magrathea currently supports [Magrathea](https://github.com/DavidRRice/Magrathea) output files which take in the mass of the various layers of a planet (core, mantle, hydrosphere, and atmosphere) and return the pressure, temperature, density, and phase of the planet at various radii. An example output is shown below.
